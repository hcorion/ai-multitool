...
class AgentPreset(BaseModel):
    ...
    model: str = Field(
        default="gpt-5.5", description="Model to use (gpt-5.5, gpt-5.4, gpt-5.3-codex, gpt-5.2, gpt-5.1, gpt-5, gpt-5-mini, gpt-5-pro)"
    )
    ...
    def validate_model(cls, v: str) -> str:
        """Validate model type."""
        valid_models = {"gpt-5.5", "gpt-5.4", "gpt-5.3-codex", "gpt-5.2", "gpt-5.1", "gpt-5", "gpt-5-mini", "gpt-5-pro"}
