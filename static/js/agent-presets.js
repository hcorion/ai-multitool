 ...
 */
export async function deleteAgentPreset(presetId) {
    try {
        const response = await fetch(`/agents/${presetId}`, {
            method: 'DELETE',
            headers: {
 ...
 */
export function setActiveAgentPreset(preset) {
 ...
 */
export function setMessageReasoningLevel(level) {
 ...
 */
export async function loadActivePresetFromStorage() {
    try {
 ...
 */
function updateAgentPresetDisplay() {
 ...
 */
function updateReasoningLevelDisplay() {
 ...
 */
export function validateAgentPresetForm(formData) {
    const errors = [];
    ...
    if (!['gpt-5.5', 'gpt-5.4', 'gpt-5.3-codex', 'gpt-5.2', 'gpt-5.1', 'gpt-5', 'gpt-5-mini', 'gpt-5-pro'].includes(formData.model)) {
 ...
 */
export function handleAgentPresetError(error, operation) {
