...
export interface Checkpoint {
    ...
    imageWidth: number;
    imageHeight: number;
    tileSize: number; // Size of each tile (256x256)
}
...
export class HistoryManager {
     ...
     */
    public createTileBasedCheckpoint(maskData: Uint8Array): Checkpoint {
        if (this.imageWidth === 0 || this.imageHeight === 0) {
     ...
     */
    public createFullCheckpoint(maskData: Uint8Array): Checkpoint {
        const checkpoint: Checkpoint = {
     ...
     */
    private extractTiles(maskData: Uint8Array): TileData[] {
     ...
     */
    private extractTile(maskData: Uint8Array, tileX: number, tileY: number): Uint8Array {
     ...
     */
    private isTileNonEmpty(tileData: Uint8Array): boolean {
     ...
     */
    public reconstructMaskFromCheckpoint(checkpoint: Checkpoint): Uint8Array {
        if (checkpoint.maskData) {
     ...
     */
    private applyTileToMask(maskData: Uint8Array, tile: TileData, imageWidth: number, tileSize: number): void {
     ...
     */
    private shouldCreatePeriodicCheckpoint(): boolean {
     ...
     */
    public getStrokesSinceLastCheckpoint(): number {
     ...
     */
    public replayFromCheckpoint(checkpoint: Checkpoint, targetStrokeIndex: number, replayCallback: (stroke: StrokeCommand) => void): Uint8Array {
