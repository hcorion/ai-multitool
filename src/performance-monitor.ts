...
export interface PerformanceConfig {
    ...
    warningThreshold: number; // FPS below this triggers warnings
}
...
export class PerformanceMonitor {
    ...
    private readonly TARGET_FRAME_TIME_60FPS = 16.67; // 60 FPS target in milliseconds
    
    // Performance warning callbacks
    private onPerformanceWarning: ((metrics: PerformanceMetrics) => void) | null = null;
     ...
     */
    public setPerformanceWarningCallback(callback: (metrics: PerformanceMetrics) => void): void {
